import {
  Users as ImportedUsers,
  Patients as ImportedPatients,
} from "./user.interface";

// Define a single user structure
...
// Note: The imported Users interface is now referred to as ImportedUsers

// Define a doctor structure
...
// Define a collection of doctors
...
// Define a collection of patients
  ...
  const doctors = [
    {
      id: "d1",
      name: "Dr. Phil Seuss",
      email: "philseuss@nafsihealth.com",
    ...
    },
    {
      ...
      email: "robertoppenheimer@nafsihealth.com",
      specialization: "Neurology",
      phone: "555-234-5678",
    },
    {
      id: "d3",
      name: "Dr. Shawn Carter",
      email: "shwancarter@nafsihealth.com",
  ...
  const appointments = [
    {
      id: "apt1",
      doctorId: "d1",
      doctorName: "Dr. Robert Oppenheimer",
      patientId: "p1",
      patientName: "Tony Montana",
  ...
  const medicalRecords = [
    {
      ...
      notes:
        "Patient reports occasional headaches. Recommend lifestyle changes.",
      doctorId: "d1",
      doctorName: "Dr. Robert Oppenheimer",
    },
    {
      ...
      notes:
        "Patient experiences nasal congestion and itchy eyes during spring.",
      doctorId: "d3",
      doctorName: "Dr. Shawn Carter",
    },
    {
...
export { User, Users, Doctor, Doctors, Patient, Patients };
